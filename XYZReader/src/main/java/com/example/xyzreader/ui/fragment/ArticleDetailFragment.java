...
import com.example.xyzreader.ui.wedget.DrawInsetsFrameLayout;
import com.example.xyzreader.ui.wedget.DynamicHeightNetworkImageView;
import com.example.xyzreader.ui.wedget.ObservableScrollView;
...
public class ArticleDetailFragment extends Fragment implements
    ...
    private int mColorBackground,mColorTextTitle,mColorTextSubtitle;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTitleContainerView=mRootView.findViewById(R.id.meta_bar);

        mStatusBarColorDrawable = new ColorDrawable(0);
        mColorBackground=getResources().getColor(R.color.details_title_background);
        mColorTextTitle=getResources().getColor(R.color.detailsTextColorTitle);
        mColorTextSubtitle=getResources().getColor(R.color.detailsTextColorSubtitle);

        ViewCompat.setElevation(mTitleContainerView, getResources().getDimension(R.dimen.cardview_default_elevation));
        ...
        mRootView.findViewById(R.id.share_fab).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(Intent.createChooser(ShareCompat.IntentBuilder.from(getActivity())
                        .setType("text/plain")
                        .setStream(Uri.parse(mCursor.getString(ArticleLoader.Query.PHOTO_URL)))
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            Glide.with(ArticleDetailFragment.this)
                    .load(imageUrl)
                    .crossFade()
                    ...
                    .listener(GlidePalette.with(imageUrl).intoCallBack(new BitmapPalette.CallBack() {
                        ...
                        public void onPaletteLoaded(Palette palette) {
                            ...
                            if (swatch != null) {
                                ...
                                mTitleContainerView.setBackgroundColor(mColorBackground);
                                titleView.setTextColor(mColorTextTitle);
                                bylineView.setTextColor(mColorTextSubtitle);
                            }
                        }
                    }))
                    .into( mPhotoView);
